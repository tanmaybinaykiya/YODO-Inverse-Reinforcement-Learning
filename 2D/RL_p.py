...
if __name__ == '__main__':
    ...
    # Supervised Success :
    # Unsupervised : [94, 624, 788, 77, 275, 394, 107, 317, 329, 201]
    # test
    ...
    # train_supervised
    for i in range(50):
        RLTrainer(states_x=350, states_y=350, blocks_count=3, iteration_count=1000, debug=False).q_learning_supervised_new(use_old=False)
        use_old = True
    ...
    use_old = False
    for i in range(50):
        RLTrainer(states_x=350, states_y=350, blocks_count=3, iteration_count=1000, debug=False).q_learning_real(use_old=use_old)
        use_old = True
