...
class BlockWorld:
    ...
    def __init__(self, screen_width, screen_height, num_blocks=2,num_stacks=2):
    ...
    def create_goal(self, num_stacks, block_order, seed, block_size=30, goal_screen=(200, 200)):
        ...
        for stack_num in range(num_stacks):
            for i in range(blocks_per_stack):
                pygame.draw.rect(self.goal_surface,COLORS[block_order[last_used_block]],(stack_num*35+40,150-30*i,block_size,block_size))
        ...
        if self.num_blocks%2==1 and last_used_block!=self.num_blocks:
            while last_used_block!=self.num_blocks:
                pygame.draw.rect(self.goal_surface,COLORS[block_order[last_used_block]],((seed)*35+40,150-30*(blocks_per_stack),block_size,block_size))
